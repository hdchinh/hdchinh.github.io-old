    ...
    <section class="ftco-section bg-light">
          ...
          <div class="col-md-6 col-lg-4 ftco-animate">
            <div class="blog-entry">
              <a href="blog-single.html" class="block-20 d-flex align-items-end" style={{ backgroundImage: "url(" + Image1 + ")" }}>
              ...
              <div class="text bg-white p-4">
                <h class="heading"><a href="#">Finance And Legal Working Streams Occur Throughout</a></h>
                <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                <div class="d-flex align-items-center mt-4">
	                <p class="mb-0"><a href="#" class="btn btn-primary">Read More </a></p>
